...
def realtime_detecting():
    ...
    while True:
        ...
        body_point =  util.get_body_point()
        print('point: ',body_point)
        ...
        if len(body_point) == 0:
            ...
            for i in range(len(body_point)):
                x = int(body_point[i][0])
                y = int(body_point[i][1])
                ...
                if target_area[y][x] == 1:
                    ...
                    state.append(object_state)
            if sum(state) > 0:
                print('손이 컵에 가 있지 않습니다.')
                state_time = 0
            else:
                state_time += 1
                print('손이 컵에 가 있습니다.')
                if state_time >= 1:
                    playsound("./warning_cup.mp3")
                    state_time = 0
        ...
        if len(RShoulder_point) == 1 and len(LShoulder_point) == 1 and len(Nose_point) == 1 and len(Neck_point) == 1:
            ...
            if current_pose == post_pose:
                ...
                if pose_score > 7:
                    ...
                    playsound("./warning_direction3.mp3")
                elif pose_score > 5:
                    playsound("./warning_direction2.mp3")
                elif pose_score > 3:
                    playsound("./warning_direction1.mp3")
            else:
                pose_score = 0  
